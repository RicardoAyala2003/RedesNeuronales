...
class NeuralNetwork:
    def __init__(self, input_size, hidden_size, output_size, learning_rate=0.1):  # Reducir la tasa de aprendizaje
        ...
        self.capa1.weights_loader("Mnist/pesosguardados")
        self.capa2.weights_loader("Mnist/pesosguardados")
    ...
    def train(self, X, y, epochs):
        for epoch in range(epochs):
            ...
            self.capa1.weights_saver("Mnist/pesosguardados")
            self.capa2.weights_saver("Mnist/pesosguardados")
